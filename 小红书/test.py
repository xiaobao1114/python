...
def read_mysql(cnn):
    ...
    df2 = pd.read_sql_query('select content_id  from test123.ods_static_app_social_xhs_contents_ft_new group by content_id', cnn)
    ...
    content_ids = []
    for content_id in filtered_df['content_id'].drop_duplicates():
